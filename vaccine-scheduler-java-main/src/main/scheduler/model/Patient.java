...
public class Patient {
    ...
    public void deleteAvailability(Date d, String care_name) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();
    ...
    public void saveToApp(int ID, String V_name, Date d, String P_name,String C_name) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();
    ...
    public void uploadAvailability(Date d, String C_name) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();
